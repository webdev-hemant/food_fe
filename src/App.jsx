...
import Goals from "./pages/GoalTracking";
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 bg-gray-100 p-4">
          ...
          <Routes>
            ...
            <Route path="/meallogs" element={user ? <MealLogs /> : <Navigate to="/login" />} />
            <Route path="/health-profile" element={user ? <HealthProfile /> : <Navigate to="/login" />} />
